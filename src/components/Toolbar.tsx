      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative group/add">
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 bg-indigo-600 hover:bg-indigo-700 hover:shadow-md text-white rounded-full text-xs sm:text-sm font-semibold transition-all group-hover/add:rounded-b-none whitespace-nowrap"
          >
        ...
        <div className="relative group/links">
          <button
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 hover:bg-slate-100 text-slate-700 rounded-full text-xs sm:text-sm font-medium transition-all whitespace-nowrap"
          >
